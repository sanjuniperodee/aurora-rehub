...
const team = [
  { name: 'Ибрагимов Сухраб Рустамович', role: 'Директор & Основатель', description: 'Визионер и основатель центра. Определяет стратегию развития и ценности, создавая безопасное пространство для изменений.', icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>), color: '#3b82f6', photo: '/team/suhrab-director.jpg' },
  { name: 'Балхан Нурсултан Сабитович', role: 'Руководитель программы', description: 'Консультант по аддиктологии. Разрабатывает и курирует терапевтический процесс, обеспечивая индивидуальный подход.', icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>), color: '#8b5cf6', photo: '/team/nursultan-program-manager.jpg' },
  { name: 'Серикбаев Нурлан Айдарович', role: 'Врач-нарколог', description: 'Психиатр-аддиктолог с 12-летним опытом. Медицинское сопровождение, стабилизация состояния и снижение рисков.', icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>), color: '#ef4444', photo: '/team/nurlan-narcologist.jpg' },
  { name: 'Ледовских Светлана Вадимовна', role: 'Клинический психолог', description: 'Специалист КПТ и арт-терапии. Работает с глубинными травмами, зависимым поведением и родственниками.', icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 2a4 4 0 0 1 4 4c0 1.5-.8 2.8-2 3.5L14 21h-4l0-11.5C8.8 8.8 8 7.5 8 6a4 4 0 0 1 4-4z"/><path d="M8 6c-2 0-4 1.5-4 4s2 4 4 4"/><path d="M16 6c2 0 4 1.5 4 4s-2 4-4 4"/></svg>), color: '#8b5cf6', photo: '/team/svetlana-psychologist.jpg' },
  { name: 'Ербол Кайсар Ерболулы', role: 'Связи с общественностью', description: 'Отвечает за внешние коммуникации, социальные проекты и взаимодействие центра с обществом.', icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>), color: '#10b981', photo: '/team/kaysar-public-relations.png' },
  { name: 'Керимкулов Баглан Байжанович', role: 'Кризис менеджер', description: 'Управление кризисными ситуациями и экстренная поддержка', icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 8v4M12 16h.01"/></svg>), color: '#f59e0b', photo: '/team/baglan-crisis-manager.png' },
];
