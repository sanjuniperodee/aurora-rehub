...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/77053505988?text=${message}`, '_blank');
  };
        ...
        <div className="contact-grid">
          ...
          >
            ...
            <div className="contact-details">
              <a href="tel:+77053505988" className="contact-item">
                ...
                <div className="contact-text">
                  ...
                  <span className="contact-value">+7 705 350 59 88</span>
                </div>
              </a>

              <a href="https://wa.me/77053505988" target="_blank" rel="noopener noreferrer" className="contact-item">
