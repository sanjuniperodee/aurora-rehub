...
const navLinks = [
  ...
  { name: 'Пакеты услуг', href: '#packages' },
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.5)', lineHeight: 1.6, maxWidth: '280px' }}>
              Открытый реабилитационный центр в Алматы. Био-Психо-Социальная модель восстановления.
            </p>
          </div>
        ...
        >
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)' }}>
            © 2025 Avrora Nomad. Все права защищены.
          </p>
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)' }}>
            Реабилитационный центр в Алматы
          </p>
        </div>
      </div>
    </footer>
